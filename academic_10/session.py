...
class session(models.Model):
    ...
    total_attendees = fields.Integer(compute="_calc_total_attendees", string="Total Attendee", required=False, ) 
    ...
    def _calc_total_attendees(self):
        for rec in self:
                rec.total_attendees = len(rec.attendee_ids)
